          ...
          <>
            {showLinks ? (
              <div className='flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow-md'>
                ...
                {/* <p className='text-sm text-gray-700 mb-2'>Non-clickable Link: https://ipfs.io/ipfs/{hash}</p>
                <a href={'https://ipfs.io/ipfs/' + hash} className='text-blue-500 hover:underline'>
              ...
              <div className='flex flex-col'>
                <div className='flex flex-col items-center mb-4'>
                  ...
                  {selectedType === 'subscription' && (
                    <select className='w-full p-2 mb-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3D00B7]'>
                      <option value='' disabled>
                        Select Bucket
                      </option>
